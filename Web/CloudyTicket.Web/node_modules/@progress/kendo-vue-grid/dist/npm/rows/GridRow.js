...
var GridRowVue2 = {
  ...
  render: function render(createElement) {
    ...
    var className = this.$props.rowType === 'groupFooter' || this.$props.rowType === 'groupHeader' ? this.$props.rowType === 'groupFooter' && 'k-group-footer' || 'k-grouping-row' : (this.$props.isAltRow ? 'k-master-row k-alt' : 'k-master-row') + (this.$props.selectedField !== undefined && (0, main_1.getNestedValue)(this.$props.selectedField, this.$props.dataItem) ? ' k-selected' : '');
