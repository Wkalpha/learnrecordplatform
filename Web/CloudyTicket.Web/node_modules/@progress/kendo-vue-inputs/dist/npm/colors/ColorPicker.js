...
var ColorPickerVue2 = {
  ...
  computed: {
    ...
    wrapperClassName: function wrapperClassName() {
      ...
      return _a = {
        ...
        'k-colorpicker': true,
        'k-icon-picker': true
      }, _a["k-picker-".concat(kendo_vue_common_1.kendoThemeMaps.sizeMap[size] || size)] = size, _a["k-picker-".concat(fillMode)] = fillMode, _a["k-rounded-".concat(kendo_vue_common_1.kendoThemeMaps.roundedMap[rounded] || rounded)] = rounded, _a['k-invalid'] = !this.valid, _a['k-disabled'] = this.disabled, _a['k-focus'] = this.focused, _a;
    }
  },
  created: function created() {
    (0, kendo_vue_common_1.validatePackage)(package_metadata_1.packageMetadata);
    this._popupId = 'popup' + (0, kendo_vue_common_1.guid)();
    this.focusableElementGuid = (0, kendo_vue_common_1.guid)();
  },
  ...
  render: function render(createElement) {
    ...
    var renderFlatColorPicker = function renderFlatColorPicker() {
      return h(FlatColorPicker_1.FlatColorPicker, __assign({
        ...
        ref: (0, kendo_vue_common_1.setRef)(this, 'flatcolorpicker'),
        view: view,
    ...
    return h("span", {
      ...
      "class": (0, kendo_vue_common_1.classNames)('k-value-icon', 'k-color-preview', {
        'k-no-color': !this.computedValue,
        'k-icon-color-preview': this.icon || this.iconClassName
      })
    }, [(this.iconClassName || this.icon) && h("span", {
      "class": (0, kendo_vue_common_1.classNames)('k-color-preview-icon', this.iconClassName, (_a = {}, _a["k-icon k-i-".concat(this.icon)] = this.icon && !this.iconClassName, _a))
    }), h("span", {
  ...
  methods: {
    ...
    onBlurHandler: function onBlurHandler() {
      clearTimeout(this.blurTimeoutRef);
      this.palette = (0, kendo_vue_common_1.getRef)(this, 'palette');
      this.gradient = (0, kendo_vue_common_1.getRef)(this, 'gradient');
