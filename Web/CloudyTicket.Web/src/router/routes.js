...
export default [{
  ...
  },
  {
    ...
    name: 'product-detail',
    component: () => import('../views/pages/ecommerce/product-detail/index.vue')
  },
  {
  ...
  },
  {
    ...
    name: 'login-test',
    component: () => import('../views/pages/auth/login-test.vue')
  },
  {
    path: '/auth/logout',
    name: 'logout',
  ...
  {
    path: '/reimbursed-voucher/once',
    name: 'reimbursed-voucher-once',
    component: () => import('../views/pages/reimbursed-voucher/once.vue')
  },
  {
    path: '/reimbursed-voucher/batch',
    name: 'reimbursed-voucher-batch',
    component: () => import('../views/pages/reimbursed-voucher/batch.vue')
  },
  {
    path: '/supplier/create-supplier',
    name: 'create-supplier',
    component: () => import('../views/pages/supplier/create-supplier.vue')
  },
  {
    path: '/supplier/list-supplier',
    name: 'list-supplier',
    component: () => import('../views/pages/supplier/list-supplier.vue')
  },
  {
    path: '/supplier/detail-supplier/:supplierId',
    name: 'detail-supplier',
    component: () => import('../views/pages/supplier/detail-supplier.vue')
  },
  {
    path: '/voucher/create-voucher',
    name: 'create-voucher',
    component: () => import('../views/pages/voucher/create-voucher.vue')
  },
  {
    path: '/voucher/list-voucher',
    name: 'list-voucher',
    component: () => import('../views/pages/voucher/list-voucher.vue')
  },
  {
    path: '/voucher/update-voucher/:voucherId',
    name: 'update-voucher',
    component: () => import('../views/pages/voucher/update-voucher.vue')
  },
  {
    path: '/voucher/detail-voucher/:voucherId',
    name: 'detail-voucher',
    component: () => import('../views/pages/voucher/detail-voucher.vue')
  },
  {
    path: '/voucher/test-voucher',
    name: 'test-voucher',
    component: () => import('../views/pages/voucher/test-voucher.vue')
  },
  {
    path: '/issue-voucher/list-issuevoucher',
    name: 'list-issuevoucher',
    component: () => import('../views/pages/issue-voucher/list-issuevoucher.vue')
  },
  {
    path: '/issue-voucher/voucher-detail/:voucherId',
    name: 'voucher-detail',
    component: () => import('../views/pages/issue-voucher/voucher-detail.vue')
  },
  {
    path: '/issue-voucher/issue-voucher/:voucherId',
    name: 'issue-voucher',
    component: () => import('../views/pages/issue-voucher/issue-voucher.vue')
  },
  {
    path: '/pick-voucher/list-pickevoucher',
    name: 'list-pickevoucher',
    component: () => import('../views/pages/pick-voucher/list-pickevoucher.vue')
  },
  {
    path: '/pick-voucher/pick-e-channel/:issuedVoucherId&:voucherId',
    props: true,
    name: 'pick-e-channel',
    component: () => import('../views/pages/pick-voucher/pick-e-channel.vue')
  },
  {
    path: '/pick-voucher/list-pickpvoucher',
    name: 'list-pickpvoucher',
    component: () => import('../views/pages/pick-voucher/list-pickpvoucher.vue')
  },
  {
    path: '/pick-voucher/pick-p-channel/:issuedVoucherId&:voucherId',
    props: true,
    name: 'pick-p-channel',
    component: () => import('../views/pages/pick-voucher/pick-p-channel.vue')
  },
  {
    path: '/payment/request-payment-list',
    name: 'request-payment-list',
    component: () => import('../views/pages/payment/request-payment-list.vue')
  },
  {
    path: '/test/test',
    name: 'test',
