<template>
  <Layout :pagetitle="'紙本票券總覽'">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title mb-0">取票代碼查詢</h4>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                <div class="mt-4 mt-xl-0">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="mb-3">
                        <label class="form-label" for="pickedNo">取票代碼</label>
                        <input class="form-control" type="text" v-model="searchCondition.pickedNo" id="pickedNo"
                          placeholder="輸入 文字">
                      </div>
                    </div>
                  </div>
              ...
              <div class="mt-4 mt-xl-0">
                ...
                <div class="row">
                  <Grid :style="{ height: '500px' }" :data-items="result" :sortable="true" :pageable="true"
                    ...
                    <template v-slot:pick="{ props }">
                      <detailCellWithTwoParams 
                        :data-item="props.dataItem" 
                        :param1="props.dataItem.issuedVoucherId" 
                        :param2="props.dataItem.voucherId" 
                        showText="取票"
                        detail-link="/pick-voucher/pick-p-channel">
                      </detailCellWithTwoParams>
                    </template>
                  </Grid>
                </div>
...
import detailCellWithTwoParams from '../../../components/kendo/cell-button/detailCellWithTwoParams.vue';
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { field: 'issuerName', title: '發行商名稱' },
        { field: 'pickedNo', title: '取票代碼' },
        { field: 'createTime', title: '建立時間' },
        { field: 'creator', title: '建立人員' },
        { title: '', cell: 'pick', filterable: false, width: '100px' },
      ]
    };
  },
  components: {
    Layout, Grid, detailCellWithTwoParams
  },
  watch: {
    "searchCondition.pickedNo": function (newValue) {
      this.setFilter("pickedNo", newValue, "contains");
    },
  ...
  methods: {
    ...
    fetchData: function (dataState) {
      ...
      const base_url = '/api/QueryPVoucher';
